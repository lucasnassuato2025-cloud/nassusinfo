...
export type AppIconName =
  | "home" | "users" | "calendar" | "briefcase" | "wallet" | "file" | "team"
  | "chart" | "card" | "settings" | "search" | "plus" | "bell" | "chevron"
  | "logout" | "command" | "eye" | "bolt" | "arrow" | "menu" | "close";

type Props = SVGProps<SVGSVGElement> & { name: AppIconName; size?: number };

const paths: Record<AppIconName, React.ReactNode> = {
  home: <><path d="M3 10.7 12 3l9 7.7"/><path d="M5.5 9.5V21h13V9.5"/><path d="M9 21v-6h6v6"/></>,
  users: <><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M22 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></>,
  calendar: <><rect x="3" y="5" width="18" height="16" rx="2"/><path d="M16 3v4M8 3v4M3 10h18"/><path d="M8 14h.01M12 14h.01M16 14h.01M8 18h.01M12 18h.01"/></>,
  briefcase: <><rect x="3" y="7" width="18" height="13" rx="2"/><path d="M8 7V5a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2M3 12h18M10 12v2h4v-2"/></>,
  wallet: <><path d="M4 5h15a2 2 0 0 1 2 2v12H4a2 2 0 0 1-2-2V7a2 2 0 0 1 2-2Z"/><path d="M17 11h4v5h-4a2.5 2.5 0 0 1 0-5Z"/><path d="M5 5V3h12"/></>,
  file: <><path d="M6 2h9l5 5v15H6z"/><path d="M14 2v6h6M9 13h7M9 17h7"/></>,
  team: <><circle cx="8" cy="8" r="3"/><circle cx="17" cy="9" r="2.5"/><path d="M2.5 20a5.5 5.5 0 0 1 11 0M13 19a4.5 4.5 0 0 1 8.5 0"/></>,
...
export default function AppIcon({ name, size = 18, ...props }: Props) {
  return (
